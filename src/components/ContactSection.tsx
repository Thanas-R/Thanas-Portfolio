...
const contactLinks = [
  ...
  },
  {
    ...
    icon: <TbBrandGithubFilled className="w-7 h-7" aria-hidden />,
  },
  {
    label: 'LinkedIn',
    value: 'thanasr',
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="mb-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <input
                ...
                className="w-full px-6 py-5 rounded-xl bg-secondary/60 dark:bg-secondary/40 text-foreground text-base font-medium placeholder:text-muted-foreground/70 focus:outline-none focus:ring-1 focus:ring-ring"
                required
              />
              <input
                type="email"
            ...
            <textarea
              ...
              className="w-full px-6 py-5 rounded-xl bg-secondary/60 dark:bg-secondary/40 text-foreground text-base font-medium placeholder:text-muted-foreground/70 focus:outline-none focus:ring-1 focus:ring-ring resize-y mb-8 min-h-[220px] overflow-auto scrollbar-hide"
              required
            />
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              {/* Enter guide stays on the right; compact on mobile */}
          ...
          <div className="pt-4 space-y-1.2">
            {contactLinks.map((link) => (
              ...
              >
                <div className="flex items-center gap-4 text-foreground/80 dark:text-foreground/90 group-hover:text-foreground transition-colors">
                ...
                <div className="flex items-center gap-3 text-foreground/70 dark:text-foreground/80 group-hover:text-foreground transition-colors">
