...
const socials = [
  ...
  },
  {
    ...
    tooltip: '@thanas007',
    icon: <BsTwitterX className="w-7.5 h-7.5" />
  },
  {
    label: 'Medium',
  ...
  },
  {
    ...
    icon: (
      <svg className="w-8.15 h-8.15" viewBox="0 0 24 24" fill="currentColor">
    ...
    <section className="relative min-h-[42vh] flex items-center justify-center px-6 pt-[86px] xl:pt-[120px] 2xl:pt-[150px] pb-[86px]">
      <div className="max-w-[61rem] w-full grid md:grid-cols-2 gap-10 items-center px-0 mx-0">
        <motion.div
          ...
          <div className="mt-6 flex flex-wrap items-center gap-2 max-w-md text-sm md:text-base text-muted-foreground">
  <span className="inline-flex items-center rounded-full border border-border bg-muted/70 px-3 py-1 shadow-sm backdrop-blur-sm">
    Developer
  </span>
