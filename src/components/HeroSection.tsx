              ...
              <TooltipProvider delayDuration={150} skipDelayDuration={200}>
                <Tooltip>
                  <TooltipTrigger asChild>
                     <span
                      className={`absolute bottom-[0px] right-[-10px] w-3 h-3 md:bottom-[0.08em] md:-right-[0.15em] md:w-4 md:h-4 rounded-full ring-[4px] ring-background ${statusColor} cursor-pointer transition-colors duration-300`}
