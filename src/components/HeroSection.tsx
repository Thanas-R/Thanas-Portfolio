        ...
        <motion.div
          ...
          <div style={{ perspective: '800px' }}>
            <div
              ...
              className="relative w-48 h-48 md:w-60 md:h-60 glow-card rounded-2xl transition-transform ease-out hover:[transform:rotateX(var(--xRotation))_rotateY(var(--yRotation))_scale(1.05)] overflow-hidden border-white border-4 border-solid">
