              ...
              <TooltipProvider delayDuration={150} skipDelayDuration={200}>
                <Tooltip>
                  <TooltipTrigger asChild>
                     <span
                      className={`absolute bottom-[2px] right-[-10px] w-2 h-2 md:bottom-[0.12em] md:-right-[0.15em] md:w-4 md:h-4 rounded-full ring-[4px] ring-background ${statusColor} cursor-pointer transition-colors duration-300`}
