        ...
        <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <BentoCard className="md:col-span-2 md:row-span-2 min-h-[22rem]">
              <div className="relative pl-6 space-y-5">
                ...
                <div className="relative">
                  ...
                  <p className="text-sm text-foreground/80 leading-relaxed font-quicksand mt-[4px]">
            ...
            <BentoCard className="md:col-span-4 min-h-[10rem]">
              ...
              <p className="text-muted-foreground leading-relaxed mt-3 font-quicksand text-lg">
            ...
            <BentoCard className="md:col-span-2 min-h-[10rem]">
              ...
              <p className="text-muted-foreground leading-relaxed mt-2 text-lg font-quicksand">• Testing AI models and MCPs
• B.Tech CSE (AI/ML), 2025–29
                
                <strong className="text-foreground">B.Tech</strong> at PES University, 2025–2029, majoring in CSE (AI/ML).
              </p>
            </BentoCard>
            ...
            <BentoCard className="md:col-span-2 min-h-[10rem]">
              ...
              <TooltipProvider delayDuration={100}>
                <div className="mt-4 flex items-center flex-wrap gap-[30px]">
                  {socialIcons.map((s) => <Tooltip key={s.label}>
