...
const BentoCard = ({ className, children, delay = 0 }: { className?: string; children?: ReactNode; delay?: number }) => {
  ...
  return (
    <motion.div
      ref={ref}
      style={{ y }}
      className={cn('relative group rounded-xl border border-border bg-card overflow-hidden p-4', className)}
    >
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-3">
          ...
          <BentoCard className="md:col-span-2" delay={3}>
            ...
            <p className="text-2xl md:text-3xl font-bold text-foreground font-['Space_Grotesk'] mt-2 leading-tight">Find Me Online</p>
