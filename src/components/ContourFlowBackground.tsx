...
interface ContourFlowBackgroundProps {
...
const ContourFlowBackground = ({ density: externalDensity }: ContourFlowBackgroundProps) => {
  ...
  useEffect(() => {
    ...
    const handleOrientation = (e: DeviceOrientationEvent) => {
      ...
      hasGyro = true;
      const targetX = (e.gamma / 90) * 15;
      const targetY = ((e.beta - 45) / 90) * 15;
    ...
    const handleScroll = () => {
      if (hasGyro) return;
      parallaxOffset.current.y = window.scrollY * 0.05;
    };
...
export default ContourFlowBackground;
