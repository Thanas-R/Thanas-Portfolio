...
const ProjectDetailPage = () => {
  ...
  useEffect(() => {
    ...
    if (isPesuForge) {
      preload([pesuForgeBg, project.imageSrc]);
    } else if (isPesuMC) {
      preload([pesuMcBackdrop, pesuMcHero, pesuMcIcon, project.imageSrc]);
    } else if (isSpheal) {
      preload([project.imageSrc]);
      void (window as any).__globeDataPromise?.catch?.(() => null);
      void (window as any).__sphealDotsPromise?.catch?.(() => null);
    }
  }, [project, isPesuForge, isPesuMC, isSpheal]);
  ...
  <div className="flex items-center gap-3 shrink-0">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-sm md:text-base text-foreground/80 leading-relaxed">
                    A deliberate attempt to rebuild the macOS experience inside a single React application, without iframes, without screenshots, and without shortcuts. Every window, dock icon, menu, widget, animation, and keyboard shortcut is a real component running in your browser.
                  </p>
  ...
  >
    ...
    />
              ...
              <motion.div
                ...
                style={{ backgroundColor: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 8px 32px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.06)' }}>
                <h2 className="text-xs font-bold uppercase tracking-widest text-white/35 mb-5">My Role</h2>
              ...
              <motion.div
                {...fadeUp(0.34)}
                className="rounded-2xl p-8 md:p-10 mb-16 backdrop-blur-2xl"
                style={{ backgroundColor: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 8px 32px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.06)' }}>
            ...
            <div className="max-w-4xl mx-auto px-6 pt-12 pb-24">
              ...
              <motion.div {...fadeUp(0.2)} className="border-t border-foreground/10 pt-10 mb-10">
                ...
                <ul className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  ...
                  <li>▸ Noise offsets animate over time to create a flowing drift</li>
                  <li>▸ Dark and light themes change background color and stroke opacity</li>
                </ul>
              </motion.div>
